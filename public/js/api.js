...
export const api = {
  ...
  getCollection: (id) => request('GET', `/api/collections/${id}`),
  createCollection: (data) => request('POST', '/api/collections', data),
  updateCollection: (id, data) => request('PATCH', `/api/collections/${id}`, data),
  deleteCollection: (id) => request('DELETE', `/api/collections/${id}`),
  pinSite: (id, siteId) => request('POST', `/api/collections/${id}/sites/${siteId}`),
  unpinSite: (id, siteId) => request('DELETE', `/api/collections/${id}/sites/${siteId}`),
  shareCollection: (id) => request('POST', `/api/collections/${id}/share`),
  unshareCollection: (id) => request('DELETE', `/api/collections/${id}/share`),
  ...
  deleteSchedule: (id) => request('DELETE', `/api/maintenance/${id}`),
  runMaintenance: () => request('POST', '/api/maintenance/run'),
