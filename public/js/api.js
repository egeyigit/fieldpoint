...
export const api = {
  ...
  listSiteCategories: () => request('GET', '/api/site-categories'),
  createSiteCategory: (data) => request('POST', '/api/site-categories', data),
  updateSiteCategory: (id, data) => request('PATCH', `/api/site-categories/${id}`, data),
  archiveSiteCategory: (id) => request('DELETE', `/api/site-categories/${id}`),
  restoreSiteCategory: (id) => request('POST', `/api/site-categories/${id}/restore`),
